...
### RineaRAnalyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [RineaRAnalyzer.Sample.csproj](../RineaRAnalyzer.Sample/RineaRAnalyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### RineaRAnalyzer.Tests
